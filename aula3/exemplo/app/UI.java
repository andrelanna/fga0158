	...
	public static void main(String[] args) {
		...
		do { 
			...
			case 2: 
				...
				Retangulo[] aux = new Retangulo[retangulos.length + 1];
				for (int i = 0; i < retangulos.length; i++) {
					aux[i] = retangulos[i];
				}
				
				aux[retangulos.length] = r;
				retangulos = aux;
			...
			case 3: 
				...
				Circulo[] auxiliar = new Circulo[circulos.length + 1];
				for (int i = 0; i < circulos.length; i++) {
					auxiliar[i] = circulos[i];
				}
				
				auxiliar[retangulos.length] = c;
				circulos = auxiliar;
