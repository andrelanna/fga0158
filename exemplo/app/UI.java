	...
	public static void main(String[] args) {
		...
		do { 
			...
			case 4: 
				...
				String strLado= JOptionPane.showInputDialog("Informe o lado:");
				float lado = Float.parseFloat(strLado);
				Triangulo t = new Triangulo(lado);

				//inserir q dentro do vetor quadrados.
				//Esforco bracal! 
				Triangulo[] temp3 = new Triangulo[triangulos.length + 1];
				for (int i=0; i<triangulos.length; i++) {
					temp3[i] = triangulos[i];  //copiando todas referencias de quadrados em temp
				}
				//inserir q em temp
				temp3[triangulos.length] = t;
				//atualizar referencia de quadrados
				triangulos = temp3;
		...
		for (int i=0; i<triangulos.length; i++) {
			String resposta = "triangulos " + i + "(" + triangulos[i] + ")" + ":\n"
